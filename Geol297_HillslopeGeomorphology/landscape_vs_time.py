"""
This module produces two figures representing different time intervals
in the landscape evolution of a SINGLE system. The landscape evolution 
model has uplift, linear diffusion, and run-off components. 

Settings for (1)Grid , (2)uplift rate, (3)linear diffusion, 
and (4)run-off are constant. Settings for (5)Model run are 
varied to get different time range and time steps for the two figures. 
"""
...
#5)model run
total_t=40#150            #number of years (000)
dt=0.1                 #number of years (000)  
